...
proto.DeviceStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    cycleRtime: jspb.Message.getFieldWithDefault(msg, 4, 0)
  };
...
proto.TaskStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, 0),
    state: (f = msg.getState()) && proto.TaskStatus.toObject(includeInstance, f),
...
/**
 * optional TaskStatus state = 2;
 * @return {?proto.TaskStatus}
 */
proto.TaskStatus.prototype.getState = function() {
  return /** @type{?proto.TaskStatus} */ (
    jspb.Message.getWrapperField(this, proto.TaskStatus, 2));
};
...
/**
 * optional uint32 pickup_device = 3;
 * @return {number}
 */
...
/**
 * optional uint32 place_device = 4;
 * @return {number}
 */
